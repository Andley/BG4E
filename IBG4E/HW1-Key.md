...
- 2:28a–d 是一個句子，主要子句是 2:28a，用從屬連接詞 ἵνα 帶出第三類條件句 (GGBB 696–99 = 中希 734–37) 當從屬子句 (2:28bcd)，表達希望藉由「住在基督裡」(μένετε ἐν αὐτῷ) 這個命令所產生出來的兩個目的 (GGBB 676 = 中希 714)：
	...
	- 2:28d 是第二個結果子句，進一步說明：不只 (積極面) 有膽量；而且可以 (消極面) 不蒙羞受辱[BAGD, s.v. "αἰσχύνω" 二](https://bible.fhl.net/new/s.php?N=0&k=00153&m=)。αἰσχυνθῶμεν 在新約中僅有關身和被動語態，這裡雖是被動語態的形式，但還是關身的含意。
